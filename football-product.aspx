<%@ Page Title="" Language="C#" MasterPageFile="~/AdidasShoe.master" AutoEventWireup="true" CodeFile="football-product.aspx.cs" Inherits="football_product" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <link href="css/football-product.css" rel="stylesheet" />
</asp:Content>
    ...
    <div class="breadcrumbs">
		<ul>
			...
			<li style="font-weight: 100;font-stretch: condensed;font-style: italic;">
				<i class="fa fa-caret-left" aria-hidden="true" style="margin: 0 10px;"></i><a href="football.html" style="font-weight: normal;">Football</a>
			</li>
		</ul>
		<div style="width: 400px;padding-left: 40px;">
			<p class="text-bread">football</p> <span style="display: inline;line-height: 20px;font-size:24px;font-stretch: condensed;font-weight: -200;text-transform: uppercase;">(76 products)</span>
		</div>
	</div>
		...
		<div class="section-1">
			<div style="background: #EDEDED;padding: 20px 0 0 10px;height:150px;">
				...
				<p>
					...
					<span style="font-weight: 600;">CATEGORY: </span><span>Football</span>
				</p>
			</div>
			<div>
		...
		<div class="section-2">
			...
			<div class="body-section-2">
				<div class="product-cart-basketball">
					<a href="">
						<figure class="figure-img">
							<img src="./img/football/BB6079_00_plp_standard.jpg" alt="">
				...
				<div class="product-cart-basketball">
					<a href="">
						<figure class="figure-img">
							<img src="./img/football/BY2193_00_plp_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
				...
				<div class="product-cart-basketball">
						...
						<figure class="figure-img">
							<img src="./img/football/BY2306_00_plp_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
				...
				<div class="product-cart-basketball">
					<a href="">
						<figure class="figure-img">
							<img src="./img/football/BY2463_01_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
							<span class="new-product">new</span>
							<figcaption>
			...
			<div class="body-section-2">
				<div class="product-cart-basketball">
					<a href="">
						<figure class="figure-img">
							<img src="./img/football/CP8990_00_plp_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
				...
				<div class="product-cart-basketball">
					<a href="">
						<figure class="figure-img">
							<img src="./img/football/CP9010_00_plp_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
				...
				<div class="product-cart-basketball">
						...
						<figure class="figure-img">
							<img src="./img/football/CP9024_00_plp_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
				...
				<div class="product-cart-basketball">
					<a href="">
						<figure class="figure-img">
							<img src="./img/football/CP9039_00_plp_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
							<span class="new-product">new</span>
							<figcaption>
			...
			<div class="body-section-2">
				<div class="product-cart-basketball">
					<a href="">
						<figure class="figure-img">
							<img src="./img/football/CP9152_00_plp_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
				...
				<div class="product-cart-basketball">
					<a href="">
						<figure class="figure-img">
							<img src="./img/football/CP9165_00_plp_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
							<span class="new-product">new</span>
							<figcaption>
								<span class="teaser-colors">2 colours</span>
				...
				<div class="product-cart-basketball">
						...
						<figure class="figure-img">
							<img src="./img/football/CP9899_00_plp_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
				...
				<div class="product-cart-basketball">
					<a href="">
						<figure class="figure-img">
							<img src="./img/football/S77036_00_plp_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
							<span class="new-product">new</span>
							<figcaption>
								<span class="teaser-colors">2 colours</span>
			...
			<div class="body-section-2">
				<div class="product-cart-basketball">
					<a href="">
						<figure class="figure-img">
							<img src="./img/football/S77038_01_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
				...
				<div class="product-cart-basketball">
					<a href="">
						<figure class="figure-img">
							<img src="./img/football/S77065_00_plp_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
							<span class="new-product">new</span>
							<figcaption>
								<span class="teaser-colors">2 colours</span>
				...
				<div class="product-cart-basketball">
						...
						<figure class="figure-img">
							<img src="./img/football/S77068_01_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
				...
				<div class="product-cart-basketball">
					<a href="">
						<figure class="figure-img">
							<img src="./img/football/S82369_01_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
							<span class="new-product">new</span>
							<figcaption>
								<span class="teaser-colors">2 colours</span>
			...
			<div class="body-section-2">
				<div class="product-cart-basketball">
					<a href="">
						<figure class="figure-img">
							<img src="./img/football/S77135_01_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
							<span class="new-product">new</span>
							<figcaption>
								<span class="teaser-colors">2 colours</span>
				...
				<div class="product-cart-basketball">
						...
						<figure class="figure-img">
							<img src="./img/football/S82418_01_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
				...
				<div class="product-cart-basketball">
					<a href="">
						<figure class="figure-img">
							<img src="./img/football/S82426_01_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
							<span class="new-product">new</span>
							<figcaption>
