<%@ Page Title="" Language="C#" MasterPageFile="~/AdidasShoe.master" AutoEventWireup="true" CodeFile="running-product.aspx.cs" Inherits="running_product" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <link href="css/running-product.css" rel="stylesheet" />
</asp:Content>
    ...
    <div class="breadcrumbs">
		<ul>
			...
			<li style="font-weight: 100;font-stretch: condensed;font-style: italic;">
				<i class="fa fa-caret-left" aria-hidden="true" style="margin: 0 10px;"></i><a href="football.aspx" style="font-weight: normal;">Running</a>
			</li>
		</ul>
		<div style="width: 400px;padding-left: 40px;">
			<p class="text-bread">running</p> <span style="display: inline;line-height: 20px;font-size:24px;font-stretch: condensed;font-weight: -200;text-transform: uppercase;">(76 products)</span>
		</div>
	</div>
		...
		<div class="section-1">
			<div style="background: #EDEDED;padding: 20px 0 0 10px;height:150px;">
				...
				<p>
					...
					<span style="font-weight: 600;">CATEGORY: </span><span>Running</span>
				</p>
			</div>
			<div>
		...
		<div class="section-2">
			...
			<div class="body-section-2">
				<div class="product-cart-basketball">
					<a href="">
						<figure class="figure-img">
							<img src="./img/running/BA8096_01_standard.jpg" alt="">
				...
				<div class="product-cart-basketball">
					<a href="">
						<figure class="figure-img">
							<img src="./img/running/BB1731_01_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
				...
				<div class="product-cart-basketball">
						...
						<figure class="figure-img">
							<img src="./img/running/BB1734_00_plp_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
				...
				<div class="product-cart-basketball">
					<a href="">
						<figure class="figure-img">
							<img src="./img/running/BB2986_01_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
							<span class="new-product">new</span>
							<figcaption>
			...
			<div class="body-section-2">
				<div class="product-cart-basketball">
					<a href="">
						<figure class="figure-img">
							<img src="./img/running/BB2988_01_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
				...
				<div class="product-cart-basketball">
					<a href="">
						<figure class="figure-img">
							<img src="./img/running/BB6735_00_plp_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
				...
				<div class="product-cart-basketball">
						...
						<figure class="figure-img">
							<img src="./img/running/CM7736_00_plp_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
				...
				<div class="product-cart-basketball">
					<a href="">
						<figure class="figure-img">
							<img src="./img/running/CP9987_00_plp_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
							<span class="new-product">new</span>
							<figcaption>
			...
			<div class="body-section-2">
				<div class="product-cart-basketball">
					<a href="">
						<figure class="figure-img">
							<img src="./img/running/CQ0065_00_plp_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
				...
				<div class="product-cart-basketball">
					<a href="">
						<figure class="figure-img">
							<img src="./img/running/CQ0066_00_plp_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
							<span class="new-product">new</span>
							<figcaption>
								<span class="teaser-colors">2 colours</span>
				...
				<div class="product-cart-basketball">
						...
						<figure class="figure-img">
							<img src="./img/running/CQ0158_00_plp_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
				...
				<div class="product-cart-basketball">
					<a href="">
						<figure class="figure-img">
							<img src="./img/running/CQ0159_00_plp_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
							<span class="new-product">new</span>
							<figcaption>
								<span class="teaser-colors">2 colours</span>
			...
			<div class="body-section-2">
				<div class="product-cart-basketball">
					<a href="">
						<figure class="figure-img">
							<img src="./img/running/CQ0163_00_plp_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
				...
				<div class="product-cart-basketball">
					<a href="">
						<figure class="figure-img">
							<img src="./img/running/CQ2450_00_plp_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
							<span class="new-product">new</span>
							<figcaption>
								<span class="teaser-colors">2 colours</span>
				...
				<div class="product-cart-basketball">
						...
						<figure class="figure-img">
							<img src="./img/running/DB0220_00_plp_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
				...
				<div class="product-cart-basketball">
					<a href="">
						<figure class="figure-img">
							<img src="./img/running/S80732_00_plp_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
							<span class="new-product">new</span>
							<figcaption>
								<span class="teaser-colors">2 colours</span>
			...
			<div class="body-section-2">
				<div class="product-cart-basketball">
					<a href="">
						<figure class="figure-img">
							<img src="./img/running/S80784_00_plp_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
							<span class="new-product">new</span>
							<figcaption>
								<span class="teaser-colors">2 colours</span>
				...
				<div class="product-cart-basketball">
					<a href="">
						<figure class="figure-img">
							<img src="./img/running/S82058_00_plp_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
				...
				<div class="product-cart-basketball">
						...
						<figure class="figure-img">
							<img src="./img/running/BY2768_01_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
				...
				<div class="product-cart-basketball">
					<a href="">
						<figure class="figure-img">
							<img src="./img/running/BY2772_01_standard.jpg" alt="">
							<a href="" class="favorite-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
							<span class="new-product">new</span>
							<figcaption>
